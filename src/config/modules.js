...
module.exports = {
    ...
    'amma-file': __dirname + '/../modules/core/amma-file',
    'store': __dirname + '/../modules/custom/store',
    'role': __dirname + '/../modules/custom/role',
    'user-group': __dirname + '/../modules/custom/user-group',
    'user': __dirname + '/../modules/custom/user',
